...
class EmailNotificationsRepository extends ServiceEntityRepository
{
    ...
    public function save(EmailNotifications $entity, bool $flush = false): void
    {
...
//    /**
//     * @return EmailNotifications[] Returns an array of EmailNotifications objects
//     */
...
//    public function findOneBySomeField($value): ?EmailNotifications
//    {
//        return $this->createQueryBuilder('e')
//            ->andWhere('e.exampleField = :val')
//            ->setParameter('val', $value)
