...
export default function EtatProjet({id,titre,idPh,idP,projetRole,archive,UpdateEtat,testStatus,testTask,type}) {
 ...
 const getTasks = (async () => {
    await Axios.get(`http://localhost:8000/task/${id}`
  ).then((response)=>{
