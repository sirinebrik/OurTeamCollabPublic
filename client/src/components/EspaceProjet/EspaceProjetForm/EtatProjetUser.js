...
export default function EtatProjetUser({id,titre,idPh,idP,projetRole,archive,UpdateEtat,testStatus,testTask,type,typeResponsable}) {
 ...
 const getTasks = (async () => {
    await Axios.get(`http://localhost:8000/taskUser/${id}/${typeResponsable}`
  ).then((response)=>{
