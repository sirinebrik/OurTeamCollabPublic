...
(function($) {
  ...
  $(function() {
    if ($("#performaneLine").length) {
      ...
      var salesTop = new window.Chart(graphGradient, {
          type: 'line',
          data: salesTopData,
    ...
    if ($("#performaneLine-dark").length) {
      ...
      var salesTopDark = new window.Chart(graphGradient, {
          type: 'line',
    ...
    if ($("#status-summary").length) {
      ...
      var statusSummaryChart = new window.Chart(statusSummaryChartCanvas, {
          type: 'line',
          data: statusData,
    ...
    if ($("#marketingOverview").length) {
      ...
      var marketingOverview = new window.Chart(marketingOverviewChart, {
          type: 'bar',
    ...
    if ($("#marketingOverview-dark").length) {
      ...
      var marketingOverviewDark = new window.Chart(marketingOverviewChartDark, {
          type: 'bar',
    ...
    if ($("#doughnutChart").length) {
      ...
      var doughnutChart = new window.Chart(doughnutChartCanvas, {
        type: 'doughnut',
    ...
    if ($("#leaveReport").length) {
      ...
      var leaveReport = new window.Chart(leaveReportChart, {
          type: 'bar',
    ...
    if ($("#leaveReport-dark").length) {
      ...
      var leaveReportDark = new window.Chart(leaveReportChartDark, {
          type: 'bar',
